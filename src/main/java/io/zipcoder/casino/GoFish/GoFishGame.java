...
//Instance Variables
    ...
    /**
     * Start the GoFishGame
     */
    public static void main(String[] args) {
        GoFishGame goFishGame = new GoFishGame(new Player("Something"));
        goFishGame.start();
    }
    ...
    public void checkGameOver() {
        endGameCheck = (playerBook.size() + opponentBook.size() == 13);
        if (playerBook.size() > opponentBook.size()) {
            console.println("Player wins");
        } else if (playerBook.size() < opponentBook.size()) {
